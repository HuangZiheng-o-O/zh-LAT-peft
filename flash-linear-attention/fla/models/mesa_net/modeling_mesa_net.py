...
class MesaNetModel(MesaNetPreTrainedModel):

    def __init__(self, config: MesaNetConfig):
    ...
    def forward(
        ...
        **kwargs: Unpack[Dict]
        ...
        if output_attentions:
            warnings.warn("`MesaNetModel` does not `output_attentions` now, setting it to `False`.")
