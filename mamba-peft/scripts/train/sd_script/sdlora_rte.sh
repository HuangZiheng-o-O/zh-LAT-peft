...
# 训练超参
############################
# RTE 数据量很小，需要更多epoch和更低学习率
export HP_EPOCHS=10           # 小数据任务多迭代
export HP_BATCH_SIZE=8
export HP_LR=0.00005          # 5e-5: 小数据低学习率防过拟合

############################
# 评测/保存/日志
############################
export HP_EVAL_BATCH_SIZE=64
export HP_EVAL_STEPS=100      # 小任务频繁评测观察过拟合
...
export SWANLAB_PROJECT="gla-sdlora-rte-Jan01"
